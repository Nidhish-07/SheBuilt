            ...
            <div className='flex-[4] flex items-center justify-around text-white'>
                ...
                <div className='flex gap-3'>
                    <div className='flex mr-4 cursor-pointer relative '>
                        ...
                        <span className='w-4 h-4 bg-red-600 rounded-[50%] text-white absolute top-1 left-[18px] text-xs flex items-center'><p className='absolute left-1'>1</p></span>
                    </div>
                    <div className='flex mr-4 cursor-pointer relative'>
                        <BsFillChatLeftDotsFill></BsFillChatLeftDotsFill>
                        <span className='w-4 h-4 bg-red-600 rounded-[50%] text-white absolute top-1 left-[18px] text-xs flex items-center'><p className='absolute left-1'>2</p></span>
                    </div>
                    <div className='flex mr-4 cursor-pointer relative'>
