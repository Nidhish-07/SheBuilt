...
const Navbar = () => {
    return (
        <div className="fixed inset-0 h-16 bg-[#f7f2fa] flex justify-between items-center py-0 px-9 tracking-[2px] z-10">
            ...
            <div className="flex items-center flex-row flex-nowrap h-full justify-end m-0 p-0 relative mr-auto ml-14 tablet:hidden gap-6">
            ...
            <Link to={"/"}>
                ...
                <div className="bg-transparent border-[1.5px] rounded-md border-solid border-fuchsia-500  py-2 px-4 uppercase tracking-[1.5px]  transition-all duration-500 ease-out hover:bg-fuchsia-500 hover:text-white hover:border-transparent">Login</div>
            </Link>
        </div>
    );
};
